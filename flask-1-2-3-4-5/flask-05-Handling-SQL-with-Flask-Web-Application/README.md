...
Purpose of the this hands-on training is to work with forms, connecting to database and using sql within Flask web application on Amazon Linux 2 EC2 instance. 
