# Hands-on Flask-02: Creating First Flask Application - Hello World and basic usage of Jinja Templates

Purpose of the this hands-on training is to create a Flask web application on local.

## Tasks

- Building client-server software architecture.

- Working with Python Flask framework.

- Installing Python and Flask framework on local

- Building a simple web application with Python Flask framework.

- Useing git repo to manage the application versioning.

- Runing the web application on AWS EC2 instance using the GitHub repo as codebase.
